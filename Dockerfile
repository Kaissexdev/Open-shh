...
RUN echo "Rahul" > /etc/hostname

# Force bash prompt
RUN echo 'export PS1="root@Rahul:\\w# "' >> /root/.bashrc

EXPOSE 22 4040

# Start sshd and ngrok, bind ngrok web interface to 0.0.0.0:4040
CMD ["sh", "-c", "/usr/sbin/sshd && ngrok tcp 22 --log=stdout --log-level=info --web-addr=0.0.0.0:4040"]
